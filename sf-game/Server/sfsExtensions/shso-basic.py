...
def handleInternalEvent(evt):
	...
	if evtName == "loginRequest":
		...
		if (UserCheckQueryResult.next()):
			...
			username = UserCheckQueryResult.getString("Username")
			playerID = UserCheckQueryResult.getInt("ID")
			paid = UserCheckQueryResult.getInt("Paid")
			dbpass = UserCheckQueryResult.getString("Password")
