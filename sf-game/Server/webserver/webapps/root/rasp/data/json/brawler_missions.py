...
class brawler_missions(HttpServlet):
	...
	def doGet(self, request, response):
		...
		w.println("  </headers>")
		w.println("  <body>")
		brawler_missions_file = open('sf-game/Server/webserver/webapps/root/rasp/data/json/brawler_missions.json', 'r')
		for line in brawler_missions_file.readlines():
			w.println(line)
		brawler_missions_file.close()
		w.println("</body>")
		w.println("</response>")
