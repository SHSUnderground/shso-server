...
class daily_quests(HttpServlet):
	...
	def doGet(self, request, response):
		...
		w.println("  </headers>")
		w.println("  <body>")
		# brawler_missions_file = open('sf-game/Server/webserver/webapps/root/rasp/data/json/brawler-missions', 'r')
		# for line in brawler_missions_file.readlines():
		# 	w.println(line)
		# ach_file.close()
		w.println('{"daily_quest": {"ownable_type_id": 4008}}')
		w.println("</body>")
		w.println("</response>")
