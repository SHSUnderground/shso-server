...
class card_quests(HttpServlet):
	...
	def doGet(self, request, response):
		...
		w.println("  </headers>")
		w.println("  <body>")
		card_quests_file = open('sf-game/Server/webserver/webapps/root/rasp/data/json/card_quests.json', 'r')
		for line in card_quests_file.readlines():
			w.println(line)
		card_quests_file.close()
		w.println("</body>")
		w.println("</response>")
