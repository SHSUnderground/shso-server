...
class blueprints(HttpServlet):
	...
	def doPost(self, request, response):
		...
		w.println("  </headers>")
		w.println("  <body>")
		blueprints_file = open('sf-game/Server/webserver/webapps/root/rasp/data/json/blueprints.json', 'r')
		for line in blueprints_file.readlines():
			w.println(line)
