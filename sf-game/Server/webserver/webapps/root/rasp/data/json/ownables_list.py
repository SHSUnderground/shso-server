...
class ownables_list(HttpServlet):
	...
	def doPost(self, request, response):
		...
		w.println("  </headers>")
		w.println("  <body>")
		ownables_list_file = open('sf-game/Server/webserver/webapps/root/rasp/data/json/ownables_list.json', 'r')
		for line in ownables_list_file.readlines():
			w.println(line)
		ownables_list_file.close()
