...
class daily_rewards(HttpServlet):
	...
	def doGet(self, request, response):
		...
		w.println("  </headers>")
		w.println("  <body>")
		daily_rewards_file = open('sf-game/Server/webserver/webapps/root/rasp/data/json/daily_rewards.json', 'r')
		for line in daily_rewards_file.readlines():
			w.println(line)
		daily_rewards_file.close()
		w.println("</body>")
		w.println("</response>")
