...
class level_chart(HttpServlet):
	...
	def doGet(self, request, response):
		...
		w.println("  </headers>")
		w.println("  <body>")
		level_chart_file = open('sf-game/Server/webserver/webapps/root/rasp/data/json/level_chart.json', 'r')
		for line in level_chart_file.readlines():
			w.println(line)
		level_chart_file.close()
