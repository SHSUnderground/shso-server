...
class hero_level_rewards(HttpServlet):
	...
	def doGet(self, request, response):
		...
		w.println("  </headers>")
		w.println("  <body>")
		hero_level_rewards_file = open('sf-game/Server/webserver/webapps/root/rasp/data/json/hero_level_rewards.json', 'r')
		for line in hero_level_rewards_file.readlines():
			w.println(line)
		hero_level_rewards_file.close()
